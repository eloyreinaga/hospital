...
@Controller
public class LabRealizadoIControlador {

    private final MiFacade mi;

    public LabRealizadoIControlador(MiFacade mi) {
        this.mi = mi;
    }

    @RequestMapping("/LabRealizadoI.do")
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        if ("Buscar".equals(boton)) {
            ...
            List listalabos = this.mi.getLabRealizadoInterNombre(dato);
            modelo.put("listalab", listalabos);
            return new ModelAndView("administrarlaboratorio/LabRealizadoI", modelo);
        }
        ...
        if ("Buscar".equals(sAccion)) {
            ...
            if (("".equals(diai)) || ("".equals(mesi)) || ("".equals(anioi))) {
                ...
                dato.setSeleccion(cliente.getId_almacen());   ////10-05-2015
                List listalab1 = this.mi.getLabRealizadoInterFecha(dato);
        ...
        if ("Modificar".equals(accion)) {
            ...
            Date fechaa = new Date(aniox, mesx, diax);
        ...
        datos.setCod_esta(cliente.getCod_esta());   ////10-01-2017
        List listalabb = this.mi.getLabRealizadoInter(datos);
