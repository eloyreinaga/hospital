...
public class ListarAfiliadosSumiPDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        Paragraph p = new Paragraph("LIBRO DE REGISTRO Y AFILIACION", new Font(Font.HELVETICA, 14, Font.BOLDITALIC, new Color(0, 0, 0)));
        ...
        int[] fwidths = {4, 7, 8, 10, 10, 10, 8, 6, 2, 2, 2, 2, 25, 10};
        table.setWidths(fwidths);
        table.setWidthPercentage(100);
        String sCampos[] = {"No", "Fecha\nAfiliacion", "H.CL.", "Apellido\nPaterno", "Apellido\nMaterno", "Nombres", "Fecha Nac.", "Tipo", "años", "Meses", "M", "F", "Direccion", "Municipio"};
