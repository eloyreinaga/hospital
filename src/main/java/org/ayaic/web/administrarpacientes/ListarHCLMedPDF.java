...
public class ListarHCLMedPDF extends AbstractPdfView {
    ...
    protected void buildPdfMetadata(Map model, Document document, HttpServletRequest request) {
        ...
        document.setMargins(20, 20, 10, 60);
    }
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int pag = 0; pag < HCL.size() / filas + una; pag++) {
            ...
            for (int i = pag * filas + 0; i < pag * filas + filas && i < HCL.size(); i++) {
                ...
                //finalImage.setBorder(Rectangle.ALIGN_RIGHT);
                //finalImage.setBorder(Rectangle.NO_BORDER);
                //finalImage.setWidthPercentage(1);
                //finalImage.setSpacingAfter(10);
                //finalImage.setAlignment(600);

                ////table12.addCell(finalImage);
