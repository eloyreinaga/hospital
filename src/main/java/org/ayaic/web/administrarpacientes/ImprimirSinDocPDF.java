...
public class ImprimirSinDocPDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        cb.showText(pac.getSeguro());
        cb.endText();

        cb.beginText();
        cb.setFontAndSize(bf, gral.getSuma36());
        cb.setTextMatrix(gral.getSuma34() + 25, alto - gral.getSuma35());
        cb.showText(pac.getTelefono());
        cb.endText();

        cb.beginText();
        cb.setFontAndSize(bf, gral.getSuma39());
        cb.setTextMatrix(gral.getSuma37() + 25, alto - gral.getSuma38());
        cb.showText(pac.getTipo_sanguineo());
        cb.endText();
