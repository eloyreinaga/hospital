...
@Controller
public class PrestacionSumiPacienteControlador {

    private final MiFacade mi;

    public PrestacionSumiPacienteControlador(MiFacade mi) {
        this.mi = mi;
    }

    @RequestMapping("/PrestacionSumiPaciente.do")
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        modelo.put("sw", sw);
        return new ModelAndView("administrarenfermeria/PrestacionSumiPaciente", modelo);
    }
}
