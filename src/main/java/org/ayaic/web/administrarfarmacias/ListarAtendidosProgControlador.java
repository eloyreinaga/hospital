...
@Controller
public class ListarAtendidosProgControlador {

    private final MiFacade mi;

    public ListarAtendidosProgControlador(MiFacade mi) {
        this.mi = mi;
    }

    @RequestMapping("/ListarAtendidosProg.do")
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        String cod_esta = request.getParameter("sig_centro");
        ...
        if ("adicionar".equals(accion)) {
            ...
            return new ModelAndView("administrarfarmacias/EntregaNPacienteP", modelo);
        }
