...
@Controller
public class ListaNRecetaSPSControlador {

    private final MiFacade mi;

    public ListaNRecetaSPSControlador(MiFacade mi) {
        this.mi = mi;
    }

    @RequestMapping("/ListaNRecetaSPS.do")
...
//            this.mi.setModificarMedicamentoStock(buscarMedicamento);
        ...
        return new ModelAndView("administrarfarmacias/ListaNRecetaS", modelo);
    }
}
