...
@Controller
public class ListarAtendidosSPSControlador {

    private final MiFacade mi;

    public ListarAtendidosSPSControlador(MiFacade mi) {
        this.mi = mi;
    }

    @RequestMapping("/ListarAtendidosSPS.do")
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        if ("adicionar".equals(accion)) {
            ...
            return new ModelAndView("administrarfarmacias/EntregaNPacienteS", modelo);
        }
        ...
        return new ModelAndView("administrarfarmacias/ListarAtendidosSPS", modelo);
