...
public class HCLNotaInterPDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        cell = new PdfPCell(new Phrase("Telefono :   " + pacientes.getTelefono() + "                   HCL : " + Integer.toString(pacientes.getHcl()) + "-" + Integer.toString(datopac.getId_historia()), DATO_FONT));
        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(2);
        tablex.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("NOTA DE INTERNACION\n\n", TITULO_FONT_B));
        ...
        if (!"".equals(datopac.getCadena9()) && datopac.getCadena9() != null) {
        ...
        if (!"".equals(datopac.getCadena10()) && datopac.getCadena10() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena11()) && datopac.getCadena11() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena12()) && datopac.getCadena12() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena13()) && datopac.getCadena13() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena14()) && datopac.getCadena14() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena15()) && datopac.getCadena15() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena16()) && datopac.getCadena16() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena17()) && datopac.getCadena17() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena18()) && datopac.getCadena18() != null) {
            cell = new PdfPCell(new Phrase("\n", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex3.addCell(cell);
        ...
        if (!"".equals(datopac.getCadena6()) && datopac.getCadena6() != null) {
