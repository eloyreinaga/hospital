...
public class ListarRecetaMedMultiCaja2PDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int pag = 0; pag < listaRecetas.size() / filas + una; pag++) {
            ...
            cell = new PdfPCell(new Phrase("Form. DM-303-B \n FOLIO:", DATO_FONT_B));
            ...
            cell = new PdfPCell(new Phrase("N.: " + nombpac + "  (" + (datoPac.getId_tipo_sexo() == 1 ? "F" : "M") + ") N:" + format(datoPac.getFec_nacimiento(), "dd/MM/yy") + " (" + datoPac.getEdad() + "a" + datoPac.getMes() + "m" + datoPac.getDia() + ")", DATO_FONT_F));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setColspan(3);
            table1.addCell(cell);
            ...
            if (datoHis.getDiagnostico() == null) {
