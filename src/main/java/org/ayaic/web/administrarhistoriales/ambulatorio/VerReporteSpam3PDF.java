...
public class VerReporteSpam3PDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        Paragraph p = new Paragraph("LISTADO DE PACIENTES ENFERMERIA", new Font(Font.HELVETICA, 14, Font.BOLDITALIC, new Color(0, 0, 0)));
        ...
        cell = new PdfPCell(new Phrase("Y EMERGENCIAS", TITULO_FONT));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(2);
        table1.addCell(cell);
        ...
        int[] fwidths = {5, 11, 40, 13, 6, 50};
        table.setWidths(fwidths);
        table.setWidthPercentage(100);

        String sCampos[] = {"No", "FECHA", "NOMBRE DEL PACIENTE", "No SEGURO", "Edad", "ACCIONES ENFERMERIA"};
