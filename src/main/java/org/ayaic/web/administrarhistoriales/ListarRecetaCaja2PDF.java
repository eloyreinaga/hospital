...
public class ListarRecetaCaja2PDF extends AbstractPdfView {
    ...
    protected void buildPdfMetadata(Map model, Document document, HttpServletRequest request) {
        ...
        document.setMargins(450, 20, 10, 10);
    }
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        Paragraph p = new Paragraph("RECETA MEDICA.", new Font(Font.HELVETICA, 16, Font.BOLDITALIC, new Color(0, 0, 0)));
        ...
        for (int i = 0; i < listaRecetas.size(); i++) {
            ...
            cell = new PdfPCell(new Phrase("  Form DM 301\n" + numerec, TITULO_FONT));
