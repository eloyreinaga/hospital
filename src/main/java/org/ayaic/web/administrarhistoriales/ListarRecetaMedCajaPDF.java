...
public class ListarRecetaMedCajaPDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int pag = 0; pag < listaRecetas.size() / 8 + una; pag++) {
            ...
            cell = new PdfPCell(new Phrase("DOSIS UNITARIA", DATO_FONT_A));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase("Alta", DATO_FONT_B));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setBorder(Rectangle.NO_BORDER);
            table1.addCell(cell);
            ...
            cod = idhistorial + '|' + format(datoHis.getFecha(), "dd/MM/yyyy HH:mm") + '|' + dato.getCod_esta() + '|' + dato.getId_usuario() + '|' + codmed + '|' + ip.getHostAddress();
