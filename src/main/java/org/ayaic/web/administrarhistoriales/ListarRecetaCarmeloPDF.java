...
public class ListarRecetaCarmeloPDF extends AbstractPdfView {
    ...
    private static final Font DATO_FONT_A = new Font(Font.COURIER, 13, Font.NORMAL, Color.black);
    private static final Font DATO_FONT_F = new Font(Font.HELVETICA, 12, Font.NORMAL, Color.black);
    private static final Font DATO_FONT_C = new Font(Font.HELVETICA, 10, Font.NORMAL, Color.black);
    private static final Font DATO_FONT_D = new Font(Font.HELVETICA, 45, Font.NORMAL, Color.black);
    private static final Font DATO_FONT_E = new Font(Font.COURIER, 20, Font.NORMAL, Color.black);
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        cell = new PdfPCell(new Phrase("Form. DM-303-A \n FOLIO______", DATO_FONT_B));
        cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(2);
        tablex.addCell(cell);

        cell = new PdfPCell(new Phrase("FORMULARIO INDIVIDUAL DE DOTACION \nCARMELO", DATO_FONT_A));
        ...
        cell = new PdfPCell(new Phrase("N.: " + datoPac.getNombres() + "  (" + (datoPac.getId_tipo_sexo() == 1 ? "F" : "M") + ") Nac." + format(datoPac.getFec_nacimiento(), "dd/MM/yy") + " (" + datoPac.getEdad() + "a" + datoPac.getMes() + "m" + datoPac.getDia() + ")", DATO_FONT_F));
        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
        cell.setColspan(3);
        table1.addCell(cell);
        ...
        int[] fxxwidths = {13, 60, 12, 9, 40, 12, 12}; // percentage
        table.setWidths(fxxwidths);
        table.setWidthPercentage(100);

        cell = new PdfPCell(new Phrase("Valoracion Nutricional", DATO_FONT));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(3);
        table.addCell(cell);

        cell = new PdfPCell(new Phrase("Precauciones", DATO_FONT));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(4);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("NORMAL", DATO_FONT_B));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(2);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("DIABETES", DATO_FONT_B));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(3);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("DESNUTRICION LEVE", DATO_FONT_B));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(2);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("INSUFICIENCIA RENAL O HEPATICA", DATO_FONT_B));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(3);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("DESNUTRICION MODERADA", DATO_FONT_B));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(2);
        table.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase("HIPERTENCION ARTERIAL", DATO_FONT_B));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(3);
        table.addCell(cell);
        ...
        cod = format(datoHis.getFecha(), "dd/MM/yyyy HH:mm") + '|' + dato.getCod_esta() + '|' + dato.getId_usuario() + '|' + codmed + '|' + ip.getHostAddress();
        ...
        cb.addImage(finalImage, 90, 0, 0, 90, 30, 650, true);
