...
public class ListarRecetaEmergRoja2PDF extends AbstractPdfView {

    private static final Font TITULO_FONT = new Font(Font.HELVETICA, 12, Font.BOLD, Color.red);
    private static final Font CABEZA_COLUMNA_FONT = new Font(Font.HELVETICA, 8, Font.ITALIC, Color.red);
    private static final Font DATO_FONT = new Font(Font.HELVETICA, 8, Font.NORMAL, Color.red);
    private static final Font DATO_FONT_B = new Font(Font.HELVETICA, 7, Font.NORMAL, Color.red);
    private static final Font DATO_FONT_A = new Font(Font.COURIER, 12, Font.NORMAL, Color.red);
    private static final Font DATO_FONT_G = new Font(Font.HELVETICA, 6, Font.NORMAL, Color.black);
    private static final Font DATO_FONT_F = new Font(Font.HELVETICA, 11, Font.NORMAL, Color.red);
    private static final Font DATO_FONT_C = new Font(Font.HELVETICA, 9, Font.NORMAL, Color.red);
    private static final Font DATO_FONT_D = new Font(Font.HELVETICA, 45, Font.NORMAL, Color.red);
    private static final Font DATO_FONT_E = new Font(Font.COURIER, 19, Font.NORMAL, Color.red);
    private static final Font DATO_FONT_BOLD = new Font(Font.HELVETICA, 8, Font.BOLD, Color.red);
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        if (listaRecetas.size() % filas == 0) {
            una = 0;
        } else {
            una = 1;
        }

        for (int pag = 0; pag < listaRecetas.size() / filas + una; pag++) {
            ...
            cell = new PdfPCell(new Phrase("Form. DM-303-E \n FOLIO:", DATO_FONT_B));
            ...
            cell = new PdfPCell(new Phrase("Nro.: " + numerec, DATO_FONT_F));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            cell.setBorder(Rectangle.NO_BORDER);
            tablex.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase("DIAGNOSTICO  : CIE10[" + datoHis.getCodigo() + "];  " + ((datoHis.getDiagnostico().length() > 60) ? datoHis.getDiagnostico().substring(0, 60) : datoHis.getDiagnostico()), DATO_FONT));
            cell.setColspan(7);
            table.addCell(cell);
            ...
            for (int i = pag * filas + 0; i < pag * filas + filas && i < listaRecetas.size(); i++) {
                ...
                if (datoInterna != null) {
                    ...
                    cell = new PdfPCell(new Phrase(((datoReceta.getMedicamento().length() > 25) ? datoReceta.getMedicamento().substring(0, 25) : datoReceta.getMedicamento()) + "<" + datoReceta.getForma_far() + ">" + "(" + datoReceta.getId_farmacia() + ")", DATO_FONT));
                    cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                    cell.setColspan(2);
                    table.addCell(cell);
                    ...
                    cell = new PdfPCell(new Phrase(datoReceta.getIndicacion(), DATO_FONT));
                    cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                    table.addCell(cell);
                    ...
                    cell = new PdfPCell(new Phrase(((datoReceta.getMedicamento().length() > 25) ? datoReceta.getMedicamento().substring(0, 25) : datoReceta.getMedicamento()) + "<" + datoReceta.getForma_far() + ">" + datoReceta.getConcentra(), DATO_FONT));
                    cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                    cell.setColspan(2);
                    table.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase("Observaciones..........................................................", DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setVerticalAlignment(Element.ALIGN_BOTTOM);
            cell.setBorder(Rectangle.NO_BORDER);
            cell.setColspan(5);
            ...
            for (int i = listaRecetas.size(); i < pag * filas + filas; i++) {///rellen espacios en blanco
                cell = new PdfPCell(new Phrase(" ", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                table.addCell(cell);
                for (int j = 1; j < 7; j++) {
