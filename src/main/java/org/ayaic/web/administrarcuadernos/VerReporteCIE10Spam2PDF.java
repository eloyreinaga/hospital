...
public class VerReporteCIE10Spam2PDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        Paragraph p = new Paragraph("MINISTERIO DE SALUD Y DEPORTES\nSEGURO DE SALUD\nPARA EL ADULTO MAYOR2", new Font(Font.HELVETICA, 14, Font.BOLDITALIC, new Color(0, 0, 0)));
        ...
        int[] fwidths = {4, 7, 30, 5, 45, 15};
        table.setWidths(fwidths);
        table.setWidthPercentage(100);

        String sCampos[] = {"No", "FECHA", "NOMBRES Y APELLIDOS", "EDAD", "DIAGNOSTICO", "CODIGO CIE10"};
        ...
        for (int i = 0; i < lFopos.size(); i++) {
            ...
            cell = new PdfPCell(new Phrase(CIE10, DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            table.addCell(cell);
