...
public class PedirLaboratorioCNSTodosPDF extends AbstractPdfView {
    ...
    private static final Font DATO_FONT_C = new Font(Font.HELVETICA, 14, Font.NORMAL, Color.black);
    ...
    private static final Font marcagua = new Font(Font.HELVETICA, 20, Font.BOLD, Color.lightGray);
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        if (datoLabp.isEmpty()) {
            ...
            cell = new PdfPCell(new Phrase("Patronal : " + datoPacEmp.getRegistro() + "   [" + datoPacEmp.getResultado().toLowerCase() + "]", DATO_FONT_A));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            cell.setColspan(2);
            tablex.addCell(cell);
...
//////////////////////////////////
            ...
            cell = new PdfPCell(new Phrase("SIRVASE REALIZAR :                                         ", DATO_FONT_B));
            ...
            for (int k = 0; k < datoLabp.size(); k++) {
                ...
                lab = lab + (k + 1) + ". " + listaLab.getLaboratorio() + "(" + listaLab.getTipoconsulta() + ")                   ";
