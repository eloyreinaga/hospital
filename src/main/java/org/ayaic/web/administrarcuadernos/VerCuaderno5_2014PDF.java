...
public class VerCuaderno5_2014PDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int pag = 0; pag < lFopos.size() / filas + una; pag++) {
            ...
            int[] fwidths = {8, 9, 10, 13, 35, 5, 5, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 40, 3, 3, 3, 3, 3, 3, 3, 3, 9};
            table.setWidths(fwidths);
            table.setWidthPercentage(100);

            cell = new PdfPCell(new Phrase("Cuaderno No. 5     2014                                                                                                                         Registro para el seguimiento de Internaciones en Hospitales Basicos", TITULO_FONT));
            ...
            addtitulo32(table, "Edad en años", "< 6 mes", "M", "F", "6m a 1 año", "M", "F", "1 a 4", "M", "F", "5 a 9", "M", "F", "10 a 14", "M", "F", "15 a 19", "M", "F", "20 a 39", "M", "F", "40 a 49", "M", "F", "50 a 59", "M", "F", "60 a mas", "M", "F");
            ...
            for (int i = pag * filas + 0; i < pag * filas + filas && i < lFopos.size(); i++) {
                ...
                ////menores 6 meses         
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() == 0 && datopac.getMes() < 6) ? Integer.toString(datopac.getDia()) : "", DATO_FONT)); //+":"+Integer.toString(datopac.getMes())
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[2] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() == 0 && datopac.getMes() < 6) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() == 0 && datopac.getMes() < 6) ? Integer.toString(datopac.getDia()) : "", DATO_FONT)); //+":"+Integer.toString(datopac.getMes())
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[3] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() == 0 && datopac.getMes() < 6) ? 1 : 0;
                //// 6 meses a 1 año                  
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() == 0 && datopac.getMes() > 6) ? Integer.toString(datopac.getMes()) : "", DATO_FONT)); //+":"+Integer.toString(datopac.getMes())
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[4] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() == 0 && datopac.getMes() > 6) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() == 0 && datopac.getMes() > 6) ? Integer.toString(datopac.getMes()) : "", DATO_FONT)); //+":"+Integer.toString(datopac.getMes())
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[5] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() == 0 && datopac.getMes() > 6) ? 1 : 0;
                /// 1 año a 4 años   
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 1 && datopac.getEdad() < 5) ? "1" : "", DATO_FONT)); //+":"+Integer.toString(datopac.getMes())
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[6] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 1 && datopac.getEdad() < 5) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 1 && datopac.getEdad() < 5) ? "1" : "", DATO_FONT)); //+":"+Integer.toString(datopac.getMes())
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[7] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 1 && datopac.getEdad() < 5) ? 1 : 0;
                /// 5 año a 9 años  
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[8] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[9] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? 1 : 0;
                /// 10 año a 14 años          
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[10] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[11] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? 1 : 0;
                /// 15 año a 19 años        
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[12] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[13] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? 1 : 0;
                /// 20 año a 39 años        
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[14] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[15] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? 1 : 0;
                /// 40 año a 49 años        
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[16] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[17] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? 1 : 0;
                /// 50 año a 59 años        
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[18] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[19] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? 1 : 0;
                /// mayores de 60 años
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getEdad() > 59) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[20] += (datopac.getId_cuaderno() == 2 && datopac.getEdad() > 59) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getEdad() > 59) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[21] += (datopac.getId_cuaderno() == 1 && datopac.getEdad() > 59) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getIngreso() == 0) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[22] += (datopac.getId_cuaderno() == 2 && datopac.getIngreso() == 0) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getIngreso() == 0) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[23] += (datopac.getId_cuaderno() == 1 && datopac.getIngreso() == 0) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getIngreso() == 1) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[24] += (datopac.getId_cuaderno() == 2 && datopac.getIngreso() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getIngreso() == 1) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[25] += (datopac.getId_cuaderno() == 1 && datopac.getIngreso() == 1) ? 1 : 0;
                ...
                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getCirugia() == 1) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[26] += (datopac.getId_cuaderno() == 2 && datopac.getCirugia() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getCirugia() == 1) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[27] += (datopac.getId_cuaderno() == 1 && datopac.getCirugia() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getCirugia() == 2) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[28] += (datopac.getId_cuaderno() == 2 && datopac.getCirugia() == 2) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getCirugia() == 2) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[29] += (datopac.getId_cuaderno() == 1 && datopac.getCirugia() == 2) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getAnastecia() == 1) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[30] += (datopac.getId_cuaderno() == 2 && datopac.getAnastecia() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getAnastecia() == 1) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[31] += (datopac.getId_cuaderno() == 1 && datopac.getAnastecia() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 2 && datopac.getAnastecia() == 2) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[32] += (datopac.getId_cuaderno() == 2 && datopac.getAnastecia() == 2) ? 1 : 0;

                cell = new PdfPCell(new Phrase((datopac.getId_cuaderno() == 1 && datopac.getAnastecia() == 2) ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[33] += (datopac.getId_cuaderno() == 1 && datopac.getAnastecia() == 2) ? 1 : 0;
...
//nueva hoja             
            ...
            int[] fwdidths = {8, 40, 4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 8, 8, 8, 8};
...
//muerte mayores de 5 años
    ...
    public static void addtitulo32(PdfPTable table, String cadena, String tit1, String a, String b, String tit2, String c, String d, String tit3, String e, String f, String tit4, String g, String h, String tit5, String i, String j, String tit6, String k, String l, String tit7, String m, String n, String tit8, String o, String p, String tit9, String q, String r, String tit10, String s, String t) {
...
//tercera columna de 2       
        ...
        cell = new PdfPCell(new Phrase(tit9, DATO_FONT));
        cell.setColspan(2);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table12.addCell(cell);
        ...
        cell = new PdfPCell(new Phrase(tit10, DATO_FONT));
        cell.setColspan(2);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table12.addCell(cell);
