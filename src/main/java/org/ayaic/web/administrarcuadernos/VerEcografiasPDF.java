...
public class VerEcografiasPDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        java.util.List lFopos = (java.util.List) model.get("listaEcos");
        ...
        for (int pag = 0; pag < lFopos.size() / filas + una; pag++) {
            ...
            int[] fwidths = {13, 24, 22, 30, 80, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
            table.setWidths(fwidths);
            table.setWidthPercentage(100);

            cell = new PdfPCell(new Phrase("Cuaderno No. 1  CUADERNO DE REGISTRO PACIENTES EN ECOGRAFIAS", TITULO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setColspan(36);
            table.addCell(cell);

            String sCampos[] = {"No", "FECHA", "Numero de\nHistoria\nClinica", "Numero de\nCarnet de\nAsegurado", "NOMBRE", "SIIS", "Ext.", "Prog."};
            ...
            for (int i = pag * filas + 0; i < pag * filas + filas && i < lFopos.size(); i++) {
                ...
                if (datopac.getId_seguro() == 1 || datopac.getId_seguro() == 2 || datopac.getId_seguro() == 3 || datopac.getId_seguro() == 4 || datopac.getId_seguro() == 5) {
                    ...
                    cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                    table.addCell(cell);
                    sumas[0] += (datopac.getId_seguro() == 1 || datopac.getId_seguro() == 2 || datopac.getId_seguro() == 3 || datopac.getId_seguro() == 4 || datopac.getId_seguro() == 5) ? 1 : 0;
                } else {
                    if (datopac.getId_seguro() == 0) {
                        cell = new PdfPCell(new Phrase("", DATO_FONT));
                        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                        table.addCell(cell);
                        cell = new PdfPCell(new Phrase("X", DATO_FONT));
                        ...
                        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                        table.addCell(cell);
                        sumas[1] += (datopac.getId_seguro() == 0) ? 1 : 0;
                    } else {
                        cell = new PdfPCell(new Phrase("", DATO_FONT));
                        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                        table.addCell(cell);
                        ...
                        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                        table.addCell(cell);
                        sumas[2] += (datopac.getId_seguro() > 5) ? 1 : 0;
                    }
                }
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[3] += (datopac.getId_cuaderno() == 2 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[4] += (datopac.getId_cuaderno() == 1 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[5] += (datopac.getId_cuaderno() == 2 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[6] += (datopac.getId_cuaderno() == 1 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[7] += (datopac.getId_cuaderno() == 2 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[8] += (datopac.getId_cuaderno() == 1 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[9] += (datopac.getId_cuaderno() == 2 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[10] += (datopac.getId_cuaderno() == 1 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[11] += (datopac.getId_cuaderno() == 2 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[12] += (datopac.getId_cuaderno() == 1 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[13] += (datopac.getId_cuaderno() == 2 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[14] += (datopac.getId_cuaderno() == 1 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[15] += (datopac.getId_cuaderno() == 2 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 59 && datopac.getEdad() < 120) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[16] += (datopac.getId_cuaderno() == 1 && "N".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 59 && datopac.getEdad() < 120) ? 1 : 0;
...
/////para repetidos         
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[17] += (datopac.getId_cuaderno() == 2 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[18] += (datopac.getId_cuaderno() == 1 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 4 && datopac.getEdad() < 10) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[19] += (datopac.getId_cuaderno() == 2 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[20] += (datopac.getId_cuaderno() == 1 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 9 && datopac.getEdad() < 15) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[21] += (datopac.getId_cuaderno() == 2 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[22] += (datopac.getId_cuaderno() == 1 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 14 && datopac.getEdad() < 20) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[23] += (datopac.getId_cuaderno() == 2 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[24] += (datopac.getId_cuaderno() == 1 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 19 && datopac.getEdad() < 40) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[25] += (datopac.getId_cuaderno() == 2 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[26] += (datopac.getId_cuaderno() == 1 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 39 && datopac.getEdad() < 50) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[27] += (datopac.getId_cuaderno() == 2 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[28] += (datopac.getId_cuaderno() == 1 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 49 && datopac.getEdad() < 60) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[29] += (datopac.getId_cuaderno() == 2 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 59 && datopac.getEdad() < 120) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                sumas[30] += (datopac.getId_cuaderno() == 1 && "R".equals(datopac.getTipoconsulta()) && datopac.getEdad() > 59 && datopac.getEdad() < 120) ? 1 : 0;
            ...
            for (int i = pag * filas + 0; i < pag * filas + filas && i < lFopos.size(); i++) {
                ...
                cell = new PdfPCell(new Phrase((datopac.getAccion().length() > 100) ? datopac.getAccion().substring(0, 100) : datopac.getAccion(), DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
