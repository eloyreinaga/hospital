...
public class VerReporteCIE10Spam3PDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        cell.setBorder(Rectangle.NO_BORDER);
        tablex.addCell(cell);
        cell = new PdfPCell(new Phrase("", DATO_FONT));//cell = new PdfPCell(sumi);
        ...
        cell = new PdfPCell(new Phrase("Formulario Examenes Complementarios", TITULO_FONT));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setColspan(2);
        table1.addCell(cell);
        ...
        int[] fwidths = {4, 7, 25, 5, 35, 20};
        table.setWidths(fwidths);
        table.setWidthPercentage(100);

        String sCampos[] = {"No", "FECHA", "NOMBRES Y APELLIDOS", "EDAD", "DIAGNOSTICO", "TRATAMIENTO"};
