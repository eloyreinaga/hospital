...
public class VerC2PDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int pag = 0; pag < lFopos.size() / filas + una; pag++) {
            ...
            int[] fwidths = {11, 20, 20, 20, 28, 99, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
            table.setWidths(fwidths);
            table.setWidthPercentage(100);

            cell = new PdfPCell(new Phrase("Cuaderno No. 2   REGISTRO DE CONSULTA EXTERNA  HGSJDD", TITULO_FONT));
            ...
            for (int i = pag * filas + 0; i < pag * filas + filas && i < lFopos.size(); i++) {
                ...
                if ("S".equals(datopac.getTipo())) {
                    cell = new PdfPCell(new Phrase("SIIS", DATO_FONT));
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    table.addCell(cell);
                } else {
                    if ("E".equals(datopac.getTipo())) {
            ...
            int[] fwnidths = {10, 75, 8, 8, 10, 10, 10, 10, 83, 14, 14, 14, 8};
            ...
            addfila2(table, "Tratamiento", "Ambulatororio", "Internado");
            ...
            for (int i = pag * filas + 0; i < pag * filas + filas && i < lFopos.size(); i++) {
                ...
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[0] += (datopac.getInternado() == 0) ? 1 : 0;

                cell = new PdfPCell(new Phrase(datopac.getInternado() == 1 ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[1] += (datopac.getInternado() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase(datopac.getSpeso() == 1 ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[2] += (datopac.getSpeso() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase(datopac.getAlcohol() == 1 ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[3] += (datopac.getAlcohol() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase(datopac.getFuma() == 1 ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[4] += (datopac.getFuma() == 1) ? 1 : 0;

                cell = new PdfPCell(new Phrase(datopac.getViolencia() == 1 ? "1" : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[5] += (datopac.getViolencia() == 1) ? 1 : 0;
                ...
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[6] += (datopac.getSuma30() > 0) ? 1 : 0;

                cell = new PdfPCell(new Phrase(datopac.getSuma30() > 0 ? Integer.toString(datopac.getSuma30()) : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[7] += (datopac.getSuma30() > 0) ? 1 : 0;

                cell = new PdfPCell(new Phrase(datopac.getSuma31() > 0 ? Integer.toString(datopac.getSuma31()) : "", DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);
                sumbs[8] += (datopac.getSuma31() > 0) ? 1 : 0;
