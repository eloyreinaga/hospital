...
public class Factura_1copiaPDF extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp) throws BadElementException, IOException, DocumentException {
        ...
        String medico = (String) model.get("medico");
        ...
        cell = new PdfPCell(new Phrase("Servicios y/o actividades sujetos al IVA", DATO_FONT));
        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
        cell.setBorder(Rectangle.NO_BORDER);
        tablex.addCell(cell);
        ...
        if (costo != null) {
            for (int j = 0; j < costo.size(); j++) {
                ...
                //cell = new PdfPCell(new Phrase("        "+datoc.getCosto()+" "+medico , DATO_FONT));
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                cell.setBorder(Rectangle.NO_BORDER);
                table11.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase("        " + costo1 + " Dr. " + medico, DATO_FONT));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setBorder(Rectangle.NO_BORDER);
            table11.addCell(cell);
