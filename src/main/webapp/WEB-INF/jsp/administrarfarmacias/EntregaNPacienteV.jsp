...
<div><a class="btn btn-success" href='ListarAtendidosVenta.do'>Volver</a></div>

<form name="forma" method="POST" action='<c:url value="/ListaNRecetaV.do"/>' >

    <table class="table table-striped table-bordered table-condensed table-responsive"> 
      <tr>
        <th colspan="3" align="right" bgcolor="#F2F2F2"><font size=2><center>DATOS RECETA VENTA </center></font></th>
      </tr>
      <tr bgcolor="#F2F2F2">
...
<center>
  <input type="submit" class="btn btn-primary btn-lg" value='Siguiente' onclick="document.adicionarpaciente.action='<c:url value="/ListaNRecetaV.do"/>'"></td>
</center>
