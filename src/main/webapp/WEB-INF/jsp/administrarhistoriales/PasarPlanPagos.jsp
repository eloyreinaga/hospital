...
<table class="table table-striped table-bordered table-condensed table-responsive">
    <tr>
        <td width="50%" valign="top"> 
            <table class="table table-striped table-bordered table-condensed table-responsive">
                <tr>
                    <th colspan="3" style="font-size:20pt" bgcolor="#F2F2F2"><center>PASAR PLAN PAGOS</center></th>
                </tr>
                <tr>    
                ...
                <tr>
                    <td align="right" bgcolor="#F2F2F2">CI/Cliente </td>    
                    <td><input type="text" name="ciu"  value='<c:out value="${ciu}"/>' size="12" maxlength="12" readonly></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#F2F2F2">TOTAL A PAGAR </td>    
                        ...
                        <c:if test="${Factura == 2 or Factura == 1}"> 
                            <c:if test="${estadfact != 'impresa'}"> 
                                <form name="adicionar" method="POST" action='<c:url value="/ReporteResumen.do"/>' > 
                                    <center>
                                        <input class="btn btn-primary btn-lg" type="submit" name='accion' class="adicionar" value='Plan de Pagos'>
                                    </center>
