...
function compruebaFormulario(tuinfo) {
    if (tuinfo.diagnostico.value == "" || tuinfo.diagnostico.value == null) {
        // Comprueba si contiene un string vac�o o un valor nulo
...
function cal_total(N, obj) {
    if (isNaN(obj.value) || eval(obj.value) < 0) {
        alert(obj.value + "  n�mero incorrecto");
        obj.value = N;
    } else {
        f = document.f1x;
...
function validar(obj, tipo) {
    ...
    if (obj.value == "") {
        ...
        switch (tipo) {
            ...
            case 'A' :
                for (i = 0; i < cad.length; i++) {
                    if (!((cad[i] == '�') || (cad[i] == '�') || (cad[i] == ' ') || ((cad[i] >= 'a') && (cad[i] <= 'z')) || ((cad[i] >= 'A') && (cad[i] <= 'Z')) || (cad[i] == '.') || (cad[i] == '%') || (cad[i] == '�') || (cad[i] == '�'))) {
            ...
            case 'A9':
                for (i = 0; i < cad.length; i++) {
                    if (!((cad[i] == '�') || (cad[i] == '�') || (cad[i] == '%') || (cad[i] == ' ') || ((cad[i] >= '0') && (cad[i] <= '9')) || ((cad[i] >= 'a') && (cad[i] <= 'z')) || ((cad[i] >= 'A') && (cad[i] <= 'Z')))) {
...
function cambiarVentana() {
    ...
    if ("Ocultar" == valor[0]) {
        boton1.value = "Mostrar Menu";
    } else {
        boton1.value = "Ocultar Menu";
    }
    return true;
}
